...
class Login extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <input onChange={ this.validEmail } type="text" data-testid="email-input" placeholder="Email" />
        <input onChange={ this.validSenha } type="password" data-testid="password-input" placeholder="Senha" />
