...
describe.skip('4 - Crie uma página para sua carteira com as seguintes características:', () => {
...
describe.skip('6 - Desenvolva um formulário para adicionar uma despesa contendo as seguintes características:', () => {
