...
xdescribe('7 - Implemente a lógica para preencher as opções do campo "Moedas", buscando as siglas das moedas da API', () => {
  test('Um campo para selecionar em qual moeda será registrada a despesa', async () => {
    renderWithRouterAndStore(<Wallet />, '/carteira');
    const currencyInput = await screen.findByRole('combobox', {
      name: /moeda/i,
...
xdescribe('8 - Desenvolva a opção de "Adicionar despesa" na sua tabela de gastos', () => {
...
xdescribe('9 - Desenvolva uma tabela com os gastos contendo as seguintes características:', () => {
...
xdescribe('10 - Crie um botão para deletar uma despesa da tabela contendo as seguintes características:', () => {
  const initial = initialStateWithExpenses;
